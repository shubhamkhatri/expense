...
import smart.budget.expense.exceptions.NumberRangeException;
import smart.budget.expense.ui.options.categories.CustomCategoriesActivity;
import smart.budget.expense.ui.signin.SignInActivity;
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        logoutPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            public boolean onPreferenceClick(Preference preference) {
                ...
                broadcastIntent.setAction("smart.budget.diary.ACTION_LOGOUT");
